...
public class GameScreen extends DebuggableScreen {
	...
	public GameScreen(final GameClient game, TiledMap map, RayHandler
			rayHandler, InputMultiplexer inputMultiplexer,
					  CustomTiledMapRenderer renderer) {
		this.game = game;
		...
		camera.setToOrtho(false, GameClient.SCREEN_WIDTH, GameClient
				.SCREEN_HEIGHT);
		camera.update();
		...
		list.setItems("People to take out: ", "Roger", "Michael", "Richard",
				"Roger", "Mother fkin Roger!");
